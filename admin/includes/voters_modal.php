...
<div class="modal fade" id="addnew">
  ...
  <label for="voters_id" class="col-sm-3 control-label">Voters ID</label>
  <div class="col-sm-9">
    <input type="text" class="form-control" id="voters_id_input" name="voters_id" readonly>
  </div>
</div>
...
<div id="send_email" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        ...
        <form method="POST" action="kirim.php">
          <table>
            ...
            <tr>
              <td>Subjek:</td>
              <td><input type="text" name="subjek" class="form-control" required></td>
            </tr>
            <tr>
              <td>Pesan:</td>
              <td><textarea name="pesan" cols="32" rows="5" class="form-control" required></textarea></td>
            </tr>
            <tr>
              <td></td>
